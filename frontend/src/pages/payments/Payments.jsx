    ...
    <div className='Payments'>
      ...
      <div className='Your_Order'>
        ...
        <div className='Order_summ'>
          ...
          <div className='summ'><p>Check-In:</p><p>{checkIn}</p></div>
          <div className='summ'><p>Check-Out:</p><p>{checkOut}</p></div>
          <div className='summ'><p>Guests:</p><p>{guests}</p></div>
        </div>
        <div className='Order_Break'>
          <h3>Pricing Breakdown</h3>
          <div className='summ'><p>Room Price:</p><p>Rs. {Room_Price}</p></div>
          <div className='summ'><p>Maintenance Fee:</p><p>Rs. 200</p></div>
          <div className='summ'><p>Taxes:</p><p>Rs. 15.7</p></div>
          <div className='summ'><p>Total:</p><p>Rs. {totalPrice}</p></div>
          <button className='btn' onClick={handleSubmit}>Confirm & Pay</button>
        </div>
      </div>
    </div>
  );
